...
class AirContractRESTServiceIT extends Specification {
    ...
    def "REST Contract creation with #headerInfoInput "(String payloadInput,
        ...
        '{"contractScope":{"description":"MyContract","systemName":"systematic","currencyCode":"EUR","owner":"Alberto Palma","validityStartDate":"2016-10-06","validityEndDate":"2017-10-05","typeCode":"SLA","statusCode":"Draft","mainSupplier":{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"},"dateTypeCode":"Booking","pointOfSaleScopeCode":"MultiCountry","pointsOfSale":[],"active":true,"validatingSuppliers":[{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"}],"marketingSuppliers":[],"operatingSuppliers":[],"businessDivisionCodes":["Commercial"],"contractLevel":"TICKET","remark":"hello"},"targets":[{"name":"target1","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","safetyNets":["safetyfirst"],"remarks":"remarksText","periodicity":"Monthly","payments":[{"name":"my Linear Payment","remarks":"linear"},{"name":"my Linear Payment","remarks":"not so linear"}]}],"safetyNets":[{"name":"safetyfirst","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","remarks":"remarksText"}]}' | HttpStatus.OK | 0 | "" | "" | "MultiCountry PointOfSaleScope with ZERO PointOfSale SUCCEEDS!!"
        '{"contractScope":{"description":"MyContract","systemName":"systematic","currencyCode":"EUR","owner":"Alberto Palma","validityStartDate":"2016-10-06","validityEndDate":"2017-10-05","typeCode":"SLA","statusCode":"Draft","mainSupplier":{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"},"dateTypeCode":"Booking","pointOfSaleScopeCode":"MultiCountry","pointsOfSale":[],"active":true,"validatingSuppliers":[{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"}],"marketingSuppliers":[],"operatingSuppliers":[],"businessDivisionCodes":["Commercial"],"contractLevel":"TICKET","remark":"hello"},"targets":[{"name":"target1","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","safetyNets":["safetyfirst"],"remarks":"remarksText","periodicity":"Monthly","payments":[{"name":"my Linear Payment","remarks":"linear"},{"name":"my Linear Payment","remarks":"not so linear"}]}],"safetyNets":[{"name":"safetyfirst","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","remarks":"remarksText"}]}' | HttpStatus.BAD_REQUEST | 1 | "TODOTODOTODOTODOTODOTODO" | "TODOTODOTODOTODOTODOTODO" | "ZERO PointsOfSales Fails!! as it is mandatory"
        '{"contractScope":{"description":"MyContract","systemName":"systematic","currencyCode":"EUR","owner":"Alberto Palma","validityStartDate":"2016-10-06","validityEndDate":"2017-10-05","typeCode":"","statusCode":"Draft","mainSupplier":{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"},"dateTypeCode":"Booking","pointOfSaleScopeCode":"MultiCountry","pointsOfSale":[{"name":"","code":"AB"}, {"name":"","code":"SC"}],"active":true,"validatingSuppliers":[{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"}],"marketingSuppliers":[],"operatingSuppliers":[],"businessDivisionCodes":["Commercial"],"contractLevel":"TICKET","remark":"hello"},"targets":[{"name":"target1","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","safetyNets":["safetyfirst"],"remarks":"remarksText","periodicity":"Monthly","payments":[{"name":"my Linear Payment","remarks":"linear"},{"name":"my Linear Payment","remarks":"not so linear"}]}],"safetyNets":[{"name":"safetyfirst","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","remarks":"remarksText"}]}' | HttpStatus.BAD_REQUEST | 1 | "contractScope.typeCode." | "Invalid Contract Type" | "ZERO ContractTypeCode Fails!! as it is mandatory"
        '{"contractScope":{"description":"MyContract","systemName":"systematic","currencyCode":"EUR","owner":"Alberto Palma","validityStartDate":"2016-10-06","validityEndDate":"2017-10-05","typeCode":"!ExistentContractTypeCode","statusCode":"Draft","mainSupplier":{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"},"dateTypeCode":"Booking","pointOfSaleScopeCode":"MultiCountry","pointsOfSale":[{"name":"","code":"AB"}, {"name":"","code":"SC"}],"active":true,"validatingSuppliers":[{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"}],"marketingSuppliers":[],"operatingSuppliers":[],"businessDivisionCodes":["Commercial"],"contractLevel":"TICKET","remark":"hello"},"targets":[{"name":"target1","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","safetyNets":["safetyfirst"],"remarks":"remarksText","periodicity":"Monthly","payments":[{"name":"my Linear Payment","remarks":"linear"},{"name":"my Linear Payment","remarks":"not so linear"}]}],"safetyNets":[{"name":"safetyfirst","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","remarks":"remarksText"}]}' | HttpStatus.BAD_REQUEST | 1 | "contractScope.typeCode.!ExistentContractTypeCode" | "Invalid Contract Type" | "Non-Existent ContractTypeCode Fails!! Not in reference data."
        '{"contractScope":{"description":"MyContract","systemName":"systematic","currencyCode":"EUR","owner":"Alberto Palma","validityStartDate":"2016-10-06","validityEndDate":"2017-10-05","typeCode":"SLA","statusCode":"Draft","mainSupplier":{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"},"dateTypeCode":"Booking","pointOfSaleScopeCode":"MultiCountry","pointsOfSale":[{"name":"","code":"AB"}, {"name":"","code":"SC"}],"active":true,"validatingSuppliers":[{"name":"CHINA SOUTHERN AIRLINES","code":"CZ"}],"marketingSuppliers":[],"operatingSuppliers":[],"businessDivisionCodes":["Commercial"],"contractLevel":"TICKET","remark":"hello"},"targets":[{"name":"target1","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","safetyNets":["safetyfirst"],"remarks":"remarksText","periodicity":"Monthly","payments":[{"name":"my Linear Payment","remarks":"linear"},{"name":"my Linear Payment","remarks":"not so linear"}]}],"safetyNets":[{"name":"safetyfirst","agreementTypeCode":"Performance Based","revenueTypeCode":"Service Fee","remarks":"remarksText"}]}' | HttpStatus.OK | 0 | "" | "" | "Valid (in reference data) ContractTypeCode SUCCEEDS!!"
    }
