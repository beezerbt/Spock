...
@Stepwise // allows for sequential testing
...
class AirContractRESTServiceIT extends Specification {
    ...
    @Shared def client = new RESTClient("http://localhost:8080")
